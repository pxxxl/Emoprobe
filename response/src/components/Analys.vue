<template>
    ...
    <div class="main">
        <div id="information-nav" v-if="datashow_flag" class="dis-flex direction-row-flex">
            <el-descriptions title="视频信息" direction="horizontal" :border="true" :column="1" class="inforlist">
                ...
                <el-descriptions-item class="inshow border" label="视频简介">{{ video_information.video_desc }}</el-descriptions-item>
            </el-descriptions>
            <div id="nav" class="">
